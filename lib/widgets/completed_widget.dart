...
import 'package:todo_app/widgets/show_completed_task_widget.dart';

class CompletedWidget extends StatefulWidget {
  const CompletedWidget({super.key, required this.todo});
...
class _CompletedWidgetState extends State<CompletedWidget> {
  void showTodo(BuildContext context, Todo todo) {
    Navigator.push(
      context,
      CupertinoPageRoute(
        builder: (context) => ShowCompletedTaskWidget(todo: todo),
      ),
    );
  }
